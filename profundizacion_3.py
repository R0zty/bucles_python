...
if nota >= 90:
    print('su calificacion es :', nota, 'la nota es A')

if nota >= 80:
 print('su calificacion es :', nota, 'la nota es B')

if nota >=70:
    print('su calificacion es :', nota, 'la nota es C')

if nota <= 60:
    print('su calificacion es', nota, 'la nota es D')

if nota < 60:
    print('su calificacion es', nota, 'la nota es E')
...
if promedio >= 90:
    print('su promedio es:', promedio, 'su calificacion es A')

if promedio >= 80:
    print('su promedio es:', promedio, 'su calificacion es B')

if promedio >=70:
    print('su promedio es:', promedio, 'su calificacion es C')

if promedio >= 60:
    print('su promedio es:', promedio, 'su calificacion es D')

if promedio < 60:
    print('su promedio es:', promedio, 'su calificacion es E')

# Imprima en pantalla al cantidad de ausentes

    print('total: ', cantidad_ausentes, 'ausentes')